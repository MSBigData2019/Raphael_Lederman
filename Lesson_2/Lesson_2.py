...
# Page HTML envoyee par un serveur qui contient du
# CSS : blocs, couleurs, positionnement
# et du Javascript pour ajouter de l'interactivite.
# Les moteurs de recherche interpretent ensuite ce contenu.
# On accede a ces ressources via le protocole http ou https en effectuant des requetes
# (protocole qui envoi notamment des status 404)
# Requetes :
#   - GET : recupere les elements
#   - POST : envoi entite vers l'emplacement (par exemple quand on envoi un formulaire pour effectuer recherche sur site
#   -
# Un simple affichage de la page d'accueil purepeople genere 200 requetes

# Le document contient le principal de la page web, code en HTM: le navigateur fait une requete GET pour l'afficher
# clic droit + inspect : on check le DOM (document object model), et on peut modifier tout le contenu de la page sur
# notre navigateur
# On cherche le selecteur specifique qui nous permet de trouver les elements qui nous interessent
# Trial and error sur le DevTools de Google Chrome pour reperer le bon selecteur
# soup permet de recuperer pleins d'informations de la page web a des balises particulieres
# La balise correspond a un element entre tags : une balise a contient tous les liens
